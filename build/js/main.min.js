...
var setDefaultPrice = exports.setDefaultPrice = function setDefaultPrice() {
  if (document.querySelectorAll('.modal')) {
    var yoomoneyFormPriceInputs = document.querySelectorAll('.yoomoney-form__price-input');
...
var setPrice = exports.setPrice = function setPrice() {
  if (document.querySelectorAll('.modal')) {
    ...
    modals.forEach(function (modal) {
      ...
      var priceInput = modal.querySelector('.yoomoney-form__price-input');
...
},{"./business/setPrice":1,"./modules/header/burger":3,"./modules/initBiaxialSlider":7,"./modules/initBoatSlider":8,"./modules/initModalSlider":9,"./modules/initUniaxialSlider":10,"./modules/modals/init-modals":11,"./modules/tabs/init-tabs":13,"./utils/ios-vh-fix":17}],3:[function(require,module,exports){
"use strict";
...
},{"../vendor/swiper":19}],8:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":16,"dup":6}],19:[function(require,module,exports){
