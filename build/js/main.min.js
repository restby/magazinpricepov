...
var setDefaultPrice = exports.setDefaultPrice = function setDefaultPrice() {
  var defaultPriceSum = document.querySelectorAll('.modal__price-sum');
  // const yoomoneyFormPriceInputs = document.querySelectorAll(
  //     '.yoomoney-form__price-input'
  // );

  var pricesDefault = document.querySelectorAll('.modal__tabs-control.is-active');
  pricesDefault.forEach(function (priceDefault, index) {
    var priceValue = priceDefault.getAttribute('data-price');
    defaultPriceSum[index].textContent = "\u0426\u0435\u043D\u0430: ".concat(priceValue);
  });
...
var setPrice = exports.setPrice = function setPrice() {
  ...
  modals.forEach(function (modal) {
    ...
    var buttons = modal.querySelectorAll('.item-config');
    // const priceInput = modal.querySelector('.yoomoney-form__price-input');
    var priceSum = modal.querySelector('.modal__price-sum');
    ...
    function handleButtonClick(event) {
      ...
      priceSum.textContent = "\u0426\u0435\u043D\u0430: ".concat(price);
    }
...
},{"./business/setPrice":1,"./modules/header/burger":3,"./modules/initBiaxialSlider":7,"./modules/initBoatSlider":8,"./modules/initUniaxialSlider":9,"./modules/modals/init-modals":10,"./modules/tabs/init-tabs":12,"./utils/ios-vh-fix":16}],3:[function(require,module,exports){
"use strict";
