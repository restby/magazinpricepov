      ...
      el.addEventListener('click', function (evt) {
        ...
        if (_itemsDataObject.itemsDataObject.hasOwnProperty(itemDataValue)) {
          ...
          if (document.querySelector('[data-item-img]')) {
            (0, _changeImagesUrl.changeImagesUrl)(_itemsDataObject.itemsDataObject, itemDataValue);
          }
...
},{"./changeImagesUrl":1,"./itemsDataObject":2}],5:[function(require,module,exports){
"use strict";
