  ...
  if (document.querySelectorAll('[data-button-value]')) {
    ...
    buttons.forEach(function (button) {
      button.addEventListener('click', function () {
        ...
        var setImagesData = function setImagesData() {
        ...
        if (buttonDataValue === 'noWheel') {
          sourceElement.setAttribute('srcset', "img/items/".concat(itemsObject[itemsObjectKey].urlNoWheel, ".webp"));
          imgElement.setAttribute('src', "img/items/".concat(itemsObject[itemsObjectKey].urlNoWheel, ".jpg"));
          setImagesData();
        }
        ...
        if (buttonDataValue === 'wheel2R13') {
          sourceElement.setAttribute('srcset', "img/items/".concat(itemsObject[itemsObjectKey].urlWheel2R13, ".webp"));
          imgElement.setAttribute('src', "img/items/".concat(itemsObject[itemsObjectKey].urlWheel2R13, ".jpg"));
          setImagesData();
        }
...
},{"./changeImagesUrl":1,"./itemsDataObject":2}],4:[function(require,module,exports){
"use strict";
...
},{"./business/setItemData":3,"./modules/header/burger":5,"./modules/initBiaxialSlider":9,"./modules/initBoatSlider":10,"./modules/initUniaxialSlider":11,"./modules/modals/init-modals":12,"./modules/tabs/init-tabs":14,"./utils/ios-vh-fix":18}],5:[function(require,module,exports){
"use strict";
