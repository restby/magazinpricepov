...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    var itemsDefaultPriceText = document.querySelectorAll('.modal__price-text');
    ...
    var buttonsPrice = document.querySelectorAll('.modal__tabs-control.is-active');
    buttonsPrice.forEach(function (button, index) {
      var dataPriceValue = button.getAttribute('data-price');
      // Преобразовываем строку в число и заменяем запятую на точку
      var numericValue = parseFloat(dataPriceValue.replace(',', '.'));
