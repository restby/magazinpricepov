...
exports.changeImagesData = void 0;
var _setImagesData = require("./setImagesData");
var changeImagesData = exports.changeImagesData = function changeImagesData(itemsObject, itemsObjectKey) {
  if (document.querySelectorAll('[data-button-value]')) {
    var buttons = document.querySelectorAll('[data-button-value]');
    var itemImageAltTextChapter = {
    ...
    buttons.forEach(function (button) {
      button.addEventListener('click', function () {
        var buttonDataValue = button.getAttribute('data-button-value');
        if (itemImageAltTextChapter[buttonDataValue]) {
          (0, _setImagesData.setImagesData)(buttonDataValue, itemImageAltTextChapter, itemsObject, itemsObjectKey);
        }
      });
    });
  }
...
},{"./setImagesData":3}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.itemsDataObject = void 0;
var itemsDataObject = exports.itemsDataObject = {
  tl250: {
...
for (var key in itemsDataObject) {
  if (itemsDataObject[key].itemDescr) {
    itemsDataObject[key].itemDescr = itemsDataObject[key].itemDescr.replace(/&nbsp;/g, "\xA0");
  }
}
...
exports.setImagesData = void 0;
var setImagesData = exports.setImagesData = function setImagesData(buttonDataValue, altTextChapter, itemsObject, itemsObjectKey) {
  ...
  sourceElement.setAttribute('srcset', "img/items/".concat(itemsObject[itemsObjectKey][buttonDataValue], ".webp"));
  imgElement.setAttribute('src', "img/items/".concat(itemsObject[itemsObjectKey][buttonDataValue], ".jpg"));
  var updatedAltText = altText.replace(imgElement.getAttribute('alt'), "".concat(itemsObject[itemsObjectKey].itemTitle, ", ").concat(selectedValue));
...
var _itemsDataObject = require("./itemsDataObject");
var _changeImagesData = require("./changeImagesData");
  ...
  if (document.querySelector('[data-catalog__element]')) {
    ...
    catalogElements.forEach(function (el) {
      el.addEventListener('click', function (evt) {
        ...
        if (_itemsDataObject.itemsDataObject.hasOwnProperty(itemDataValue)) {
          var itemImg = document.querySelector('[data-item-img]');
          var sourceElement = itemImg.querySelector('source');
          var imgElement = itemImg.querySelector('img');
          var altText = imgElement.getAttribute('alt');
          sourceElement.setAttribute('srcset', "img/items/".concat(_itemsDataObject.itemsDataObject[itemDataValue].urlNoWheel, ".webp"));
          imgElement.setAttribute('src', "img/items/".concat(_itemsDataObject.itemsDataObject[itemDataValue].urlNoWheel, ".jpg"));
          var updatedAltText = altText.replace(imgElement.getAttribute('alt'), "".concat(_itemsDataObject.itemsDataObject[itemDataValue].itemTitle, ", '\u0444\u043E\u0442\u043E \u0431\u0435\u0437 \u043A\u043E\u043B\u0435\u0441'"));
          imgElement.setAttribute('alt', updatedAltText);
          if (document.querySelector('[data-item-option="noWheelOption"]')) {
            ...
            dataItemElement.textContent = _itemsDataObject.itemsDataObject[itemDataValue][dataItemPrice];
          }
          if (document.querySelector('[data-item-option="noWheelH300Option"]')) {
            ...
            _dataItemElement.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice];
          }
          if (document.querySelector('[data-item-option="noWheelH600Option"]')) {
            ...
            _dataItemElement2.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice2];
          }
          if (document.querySelector('[data-item-option="noWheelH1220Option"]')) {
            ...
            _dataItemElement3.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice3];
          }
          if (document.querySelector('[data-item-option="noWheelH1220COption"]')) {
            ...
            _dataItemElement4.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice4];
          }
          if (document.querySelector('[data-item-option="wheel2R13Option"]')) {
            ...
            _dataItemElement5.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice5];
          }
          if (document.querySelector('[data-item-option="wheel2R13H300Option"]')) {
            ...
            _dataItemElement6.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice6];
          }
          if (document.querySelector('[data-item-option="wheel2R13H600Option"]')) {
            ...
            _dataItemElement7.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice7];
          }
          if (document.querySelector('[data-item-option="wheel2R13H1220Option"]')) {
            ...
            _dataItemElement8.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice8];
          }
          if (document.querySelector('[data-item-option="wheel2R13H1220COption"]')) {
            ...
            _dataItemElement9.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice9];
          }
          if (document.querySelector('[data-item-option="wheel4R13Option"]')) {
            ...
            _dataItemElement10.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice10];
          }
          if (document.querySelector('[data-item-option="wheel4R13H1220Option"]')) {
            ...
            _dataItemElement11.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice11];
          }
          if (document.querySelector('[data-item-option="wheel4R13H1220COption"]')) {
            ...
            _dataItemElement12.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice12];
          }
          if (document.querySelector('[data-item-price="noWheel"]')) {
            ...
            _dataItemElement13.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice13];
          }
          if (document.querySelector('[data-item-price="noWheelH300"]')) {
            ...
            _dataItemElement14.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice14];
          }
          if (document.querySelector('[data-item-price="noWheelH600"]')) {
            ...
            _dataItemElement15.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice15];
          }
          if (document.querySelector('[data-item-price="noWheelH1220"]')) {
            ...
            _dataItemElement16.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice16];
          }
          if (document.querySelector('[data-item-price="noWheelH1220C"]')) {
            ...
            _dataItemElement17.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice17];
          }
          if (document.querySelector('[data-item-price="wheel2R13"]')) {
            ...
            _dataItemElement18.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice18];
          }
          if (document.querySelector('[data-item-price="wheel2R13H300"]')) {
            ...
            _dataItemElement19.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice19];
          }
          if (document.querySelector('[data-item-price="wheel2R13H600"]')) {
            ...
            _dataItemElement20.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice20];
          }
          if (document.querySelector('[data-item-price="wheel2R13H1220"]')) {
            ...
            _dataItemElement21.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice21];
          }
          if (document.querySelector('[data-item-price="wheel2R13H1220C"]')) {
            ...
            _dataItemElement22.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice22];
          }
          if (document.querySelector('[data-item-price="wheel4R13"]')) {
            ...
            _dataItemElement23.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice23];
          }
          if (document.querySelector('[data-item-price="wheel4R13H1220"]')) {
            ...
            _dataItemElement24.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice24];
          }
          if (document.querySelector('[data-item-price="wheel4R13H1220C"]')) {
            ...
            _dataItemElement25.textContent = _itemsDataObject.itemsDataObject[itemDataValue][_dataItemPrice25];
          }
          if (document.querySelector('[data-item-title]')) {
            var itemTitleElement = document.querySelector('[data-item-title]');
            itemTitleElement.textContent = _itemsDataObject.itemsDataObject[itemDataValue][Object.keys(itemTitleElement.dataset)[0]];
          }
          if (document.querySelector('[data-item-descr]')) {
            var itemDescrElement = document.querySelector('[data-item-descr]');
            itemDescrElement.textContent = _itemsDataObject.itemsDataObject[itemDataValue][Object.keys(itemDescrElement.dataset)[0]];
          }
          if (document.querySelector('[data-dimensions]')) {
            var itemDimensionsElement = document.querySelector('[data-dimensions]');
            itemDimensionsElement.textContent = _itemsDataObject.itemsDataObject[itemDataValue][Object.keys(itemDimensionsElement.dataset)[0]];
          }
          if (document.querySelector('[data-full-load-capacity]')) {
            ...
            itemFullLoadCapacityElement.textContent = _itemsDataObject.itemsDataObject[itemDataValue][Object.keys(itemFullLoadCapacityElement.dataset)[0]];
          }
          if (document.querySelector('[data-curb-weight]')) {
            var itemCurbWeightElement = document.querySelector('[data-curb-weight]');
            itemCurbWeightElement.textContent = _itemsDataObject.itemsDataObject[itemDataValue][Object.keys(itemCurbWeightElement.dataset)[0]];
          }
          if (document.querySelector('[data-count-spring-leaves]')) {
            ...
            itemCountSpringLeavesElement.textContent = _itemsDataObject.itemsDataObject[itemDataValue][Object.keys(itemCountSpringLeavesElement.dataset)[0]];
          }
          if (document.querySelector('[data-count-axes]')) {
            var itemCountAxesElement = document.querySelector('[data-count-axes]');
            itemCountAxesElement.textContent = _itemsDataObject.itemsDataObject[itemDataValue][Object.keys(itemCountAxesElement.dataset)[0]];
          }
          if (document.querySelector('[data-single-axle-load]')) {
            ...
            itemSingleAxleLoadElement.textContent = _itemsDataObject.itemsDataObject[itemDataValue][Object.keys(itemSingleAxleLoadElement.dataset)[0]];
          }
          if (document.querySelector('[data-clearance]')) {
            var itemClearanceElement = document.querySelector('[data-clearance]');
            itemClearanceElement.textContent = _itemsDataObject.itemsDataObject[itemDataValue][Object.keys(itemClearanceElement.dataset)[0]];
          }
          if (document.querySelector('[data-boat-dimensions]')) {
            var itemBoatDimensionsElement = document.querySelector('[data-boat-dimensions]');
            itemBoatDimensionsElement.textContent = _itemsDataObject.itemsDataObject[itemDataValue][Object.keys(itemBoatDimensionsElement.dataset)[0]];
          }
          if (document.querySelector('[data-dump-truck-function]')) {
            ...
            itemDumpTruckFunctionElement.textContent = _itemsDataObject.itemsDataObject[itemDataValue][Object.keys(itemDumpTruckFunctionElement.dataset)[0]];
          }
          // ???
          if (document.querySelector('[data-item-img]')) {
            (0, _changeImagesData.changeImagesData)(_itemsDataObject.itemsDataObject, itemDataValue);
          }
...
},{"./changeImagesData":1,"./itemsDataObject":2}],5:[function(require,module,exports){
"use strict";
...
var _setItemData = require("./business/setItemData");
// ---------------------------------
...
},{"./business/setItemData":4,"./modules/header/burger":6,"./modules/initBiaxialSlider":10,"./modules/initBoatSlider":11,"./modules/initUniaxialSlider":12,"./modules/modals/init-modals":13,"./modules/tabs/init-tabs":15,"./utils/ios-vh-fix":19}],6:[function(require,module,exports){
"use strict";
...
},{"./focus-lock":7,"./scroll-lock":9}],7:[function(require,module,exports){
"use strict";
...
},{"../vendor/swiper":21}],11:[function(require,module,exports){
"use strict";
...
},{"../vendor/swiper":21}],12:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":18,"dup":9}],21:[function(require,module,exports){
