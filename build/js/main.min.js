...
exports.setOrderData = exports.getOrderData = void 0;
var setOrderData = exports.setOrderData = function setOrderData() {
  if (document.querySelectorAll('.modal')) {
    ...
    document.querySelectorAll('.modal__price-pay').forEach(function (button) {
      button.addEventListener('click', function () {
        var modalContainer = button.closest('.modal__content');
        var modalInfoTitle = modalContainer.querySelector('.modal__info-title').textContent;
        var modalPriceSum = modalContainer.querySelector('.modal__price-sum').textContent;
...
var getOrderData = exports.getOrderData = function getOrderData() {
  if (document.querySelector('.ym-form')) {
    var itemTitle = document.querySelector('[data-item__title]');
    var storedItemTitle = localStorage.getItem('itemTitle');
    itemTitle.textContent = storedItemTitle;
    var itemPrice = document.querySelector('[data-price-input]');
...
exports.setPrice = exports.setDefaultPrice = void 0;
var setDefaultPrice = exports.setDefaultPrice = function setDefaultPrice() {
  if (document.querySelectorAll('.modal')) {
    var priceField = document.querySelectorAll('[data-price-input]');
    var pricesDefault = document.querySelectorAll('.config__btn.is-active');
    pricesDefault.forEach(function (priceDefault, index) {
      var priceValue = priceDefault.getAttribute('data-price');
      /*
        Вариант с input:
...
var setPrice = exports.setPrice = function setPrice() {
  if (document.querySelectorAll('.modal')) {
    ...
    modals.forEach(function (modal) {
      ...
      var buttons = modal.querySelectorAll('.config__btn');
      var priceField = modal.querySelector('[data-price-input]');
      ...
      function handleButtonClick(event) {
        ...
        var isActive = clickedButton.classList.contains('is-active');
...
var _initModalSlider = require("./modules/initModalSlider");
var _initTabs = require("./modules/tabs/init-tabs");
var _burger = require("./modules/header/burger");
var _formFields = require("./modules/form-validate/form-fields");
var _setPrice = require("./business/setPrice");
var _initOrder = require("./business/initOrder");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initModalSlider.initModalSlider)();
    (0, _setPrice.setDefaultPrice)();
    (0, _setPrice.setPrice)();
    (0, _initOrder.setOrderData)();
    (0, _initOrder.getOrderData)();

    // const form = new Form();
    // window.form = form;
    // form.init();
    (0, _formFields.editInputsPlaceholder)();
  });
});
...
},{"./business/initOrder":1,"./business/setPrice":2,"./modules/form-validate/form-fields":4,"./modules/header/burger":5,"./modules/initBiaxialSlider":9,"./modules/initBoatSlider":10,"./modules/initModalSlider":11,"./modules/initUniaxialSlider":12,"./modules/modals/init-modals":13,"./modules/tabs/init-tabs":15,"./utils/ios-vh-fix":19}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.editInputsPlaceholder = void 0;
var editInputsPlaceholder = exports.editInputsPlaceholder = function editInputsPlaceholder() {
  if (document.querySelector('form[data-ym-form]')) {
    var ymForm = document.querySelector('form[data-ym-form]');
    ymForm.querySelectorAll('input').forEach(function (input) {
    ...
    ymForm.querySelectorAll('textarea').forEach(function (textarea) {
...
},{"../vendor/swiper":21}],10:[function(require,module,exports){
"use strict";
...
exports.initModalSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
// eslint-disable-next-line consistent-return
var initModalSlider = exports.initModalSlider = function initModalSlider() {
  ...
  // Перебираем каждое модальное окно
  modals.forEach(function (modal) {
    var modalSliderElement = modal.querySelector('[data-modal-slider]');
    var modalSlider = new _swiper.default(modalSliderElement, {
      simulateTouch: false,
      speed: 500,
      // autoHeight: true,
      navigation: {
...
},{"./ios-checker":18,"dup":8}],21:[function(require,module,exports){
