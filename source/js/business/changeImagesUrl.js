  ...
  if (document.querySelectorAll('[data-button-value]')) {
    ...
    buttons.forEach((button) => {
      button.addEventListener('click', () => {
        ...
        const setImagesData = () => {
          // sourceElement.setAttribute('srcset', `img/items/${itemsObject[itemsObjectKey].urlNoWheel}.webp`);
          // imgElement.setAttribute('src', `img/items/${itemsObject[itemsObjectKey].urlWheel2R13}.jpg`);
          // Проблема с привязкой urlNoWheel, urlWheel2R13 и другими вариантами, нужно как-то унифицировать
        ...
        if (buttonDataValue === 'noWheel') {
          sourceElement.setAttribute('srcset', `img/items/${itemsObject[itemsObjectKey].urlNoWheel}.webp`);
          imgElement.setAttribute('src', `img/items/${itemsObject[itemsObjectKey].urlNoWheel}.jpg`);
        ...
        if (buttonDataValue === 'wheel2R13') {
          sourceElement.setAttribute('srcset', `img/items/${itemsObject[itemsObjectKey].urlWheel2R13}.webp`);
          imgElement.setAttribute('src', `img/items/${itemsObject[itemsObjectKey].urlWheel2R13}.jpg`);
